...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '8422190094').split()]
...
DB_URI = environ.get("DB_URI", "mongodb+srv://QJcSaCxMaSHHHUKG:QJcSaCxMaSHHHUKG@cluster0.hay3yvg.mongodb.net/?appName=Cluster0")
...
# Channel Information
LOG_CHANNEL = int(environ.get("LOG_CHANNEL", "-1003386075651"))
